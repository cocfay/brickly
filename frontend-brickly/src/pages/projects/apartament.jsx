...
{project.fechaEntrega ? (
                        ...
                        <div className="p-3 my-2 d-none d-lg-block">
                            ...
                            <div className="d-flex align-items-start justify-content-between align-items-lg-center flex-column flex-md-row gap-3">
                                ...
                                <div className="d-flex justify-content-md-end flex-column">
                                    ...
                                    <a href={`https://wa.me/50237649719?text=${encodeURIComponent(`Me interesa la propiedad ${project.titulo} que vi en Brickly Homes. Quisiera contactar con un asesor para recibir más información.`)}`} target='_blank' className="rounded-1 text-center border-0 py-1" style={{ backgroundColor: 'black', color: 'white', boxSizing: 'border-box', padding: '2px 8px', fontSize: '13px' }} rel="noreferrer" aria-label="Agendar una cita para información del proyecto" onClick={handleCitaClick}><i className="fa-brands fa-whatsapp me-2" aria-hidden="true"></i> <FormattedMessage id="home.text13" /></a>
                                </div>
                            </div>
                            <br />
                            <hr/>
        ...
        <div className="brickly-fixed-bar">
            ...
            <a
                href={`https://wa.me/50237649719?text=${encodeURIComponent(`Me interesa la propiedad ${project.titulo} que vi en Brickly Homes. Quisiera contactar con un asesor para recibir más información.`)}`}
                target="_blank"
                rel="noreferrer"
