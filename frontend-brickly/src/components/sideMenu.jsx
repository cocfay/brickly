    ...
    <Offcanvas show={showOffcanvas} onHide={handleClose} placement="end" className="bg-dark text-white">
        ...
        <Offcanvas.Body>
            <Nav className="flex-column">
                ...
                <a href="https://blog.bricklyhomes.com/" target="_blank" rel="noreferrer" className="text-white text-decoration-none py-3 border-bottom border-secondary d-block" style={{ fontSize: '14px', paddingLeft: 'var(--bs-nav-link-padding-x)' }}>
                    BLOG
                </a>
