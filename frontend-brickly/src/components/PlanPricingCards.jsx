...
function PlanPricingCards({ currentPlan }) {
  ...
  const renderPeri = periodo === 'anual' ? t('Anual', 'Annual') : t('Mensual', 'Monthly');

  // Plan actualmente activo del usuario. Se recalcula en cada render porque
  // getFullUser() lee de sessionStorage/cookie. Si lo pasa el padre ya no
  // hace falta recalcular, pero se deja el fallback por seguridad.
  const currentUser = getFullUser();
  const effectiveCurrentPlan = currentPlan !== undefined
    ? currentPlan
  ...
  const handleContratar = async (plan) => {
    ...
    if (plan === effectiveCurrentPlan) return;
  ...
  return (
    <>
      ...
      <Nav activeKey={periodo} onSelect={(selectedKey) => setPeriodo(selectedKey)} className="mb-4 m-auto prices-nav py-0">
        <Nav.Item>
          <Nav.Link onClick={() => {cambiarPeriodo('mensual') }} className={periodo == 'mensual' ? 'active py-2' : ''}><FormattedMessage id='price.text2' /></Nav.Link>
        </Nav.Item>
        <Nav.Item>
          <Nav.Link onClick={() => {cambiarPeriodo('anual')}} className={periodo == 'anual' ? 'active py-2' : ''}><FormattedMessage id='price.text3' /></Nav.Link>
        </Nav.Item>
      </Nav>
              ...
              <div className='border border-1 rounded-4 h-100 d-flex flex-column overflow-hidden'>
                ...
                <div className='p-4 d-flex flex-column flex-grow-1 mt-2'>
                  ...
                  <div className='mt-5 mb-2'>
                    {renderPlanButton('BROKER_MENSUAL')}
                  </div>
                </div>
              </div>
            </Col>
            <Col md={6} xxl={3}>
              <div className='border border-1 rounded-4 h-100 d-flex flex-column overflow-hidden'>
                ...
                <div className='p-4 d-flex flex-column flex-grow-1 mt-2'>
                  ...
                  <div className='mt-5 mb-2'>
                    {renderPlanButton('AGENCIA_SILVER')}
                  </div>
                </div>
              </div>
            </Col>
            <Col md={6} xxl={3}>
              <div className='border border-1 rounded-4 h-100 d-flex flex-column overflow-hidden'>
                ...
                <div className='p-4 d-flex flex-column flex-grow-1 mt-2'>
                  ...
                  <div className='mt-5 mb-2'>
                    {renderPlanButton(extraAgents === 0 ? 'AGENCIA_GOLD' : `AGENCIA_GOLD${extraAgents + 5}`)}
                  </div>
                </div>
              </div>
            </Col>
              ...
              <div className='border border-1 rounded-4 h-100 d-flex flex-column overflow-hidden'>
                ...
                <div className='p-4 d-flex flex-column flex-grow-1 mt-2'>
                  ...
                  <div className='mt-5 mb-2'>
                    ...
                    ) : (renderPlanButton('AGENCIA_DIAMOND'))
                    }
                  </div>
                </div>
              </div>
            ...
            <Col md={6} xxl={3}>
              <div className='border border-1 rounded-4 h-100 d-flex flex-column overflow-hidden'>
                ...
                <div className='p-4 d-flex flex-column flex-grow-1 mt-2'>
                  ...
                  <div className='mt-5 mb-2'>
                    {renderPlanButton('AGENCIA_SILVER_A')}
                  </div>
                </div>
              </div>
            </Col>
            <Col md={6} xxl={3}>
              <div className='border border-1 rounded-4 h-100 d-flex flex-column overflow-hidden'>
                ...
                <div className='p-4 d-flex flex-column flex-grow-1 mt-2'>
                  ...
                  <div className='mt-5 mb-2'>
                    {renderPlanButton(extraAgents === 0 ? 'AGENCIA_GOLD_A' : `AGENCIA_GOLD${extraAgents + 5}_A`)}
                  </div>
                </div>
              </div>
            </Col>
              ...
              <div className='border border-1 rounded-4 h-100 d-flex flex-column overflow-hidden'>
                ...
                <div className='p-4 d-flex flex-column flex-grow-1 mt-2'>
                  ...
                  <div className='mt-5 mb-2'>
                    ...
                    ) : (renderPlanButton('AGENCIA_DIAMOND_A'))
                    }
                  </div>
                </div>
              </div>
