                                ...
                                <tr>
                                    <td align="left">
                                        <a href="https://www.bricklyhomes.com" target="_blank">
                                            <img src="https://www.bricklyhomes.com/newsletters/iconos/logo_negro.png" alt="Brickly Homes" width="150" style="display:block; border:0; font-family:sans-serif; font-size:18px; line-height:20px; color:#111111; font-weight:bold; background-color:#ffffff; border-radius:4px; padding:3px;">
                                        </a>
                                    </td>
